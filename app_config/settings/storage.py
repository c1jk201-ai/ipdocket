...
class StorageSettings:
    ...
    USPTO_FORM_MAX_PARSE_BYTES = _env_int("USPTO_FORM_MAX_PARSE_BYTES", 5 * 1024 * 1024)
    ...
    USPTO_PACKAGE_MAX_BYTES = _env_int("USPTO_PACKAGE_MAX_BYTES", 100 * 1024 * 1024)
    USPTO_PACKAGE_MAX_TOTAL_SIZE = _env_int(
        "USPTO_PACKAGE_MAX_TOTAL_SIZE", USPTO_PACKAGE_MAX_BYTES
    )
    ...
    USPTO_UPLOAD_AUTO_APPLY_TRUSTED = _env_bool("USPTO_UPLOAD_AUTO_APPLY_TRUSTED", False)
